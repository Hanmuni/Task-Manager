...
function render_backlog_at_help() {
    ...
    document.getElementById('help-choosed-image').classList.remove('d-none');
    document.getElementById('help-choosed-image').src = './img/backlog_help_section.png';
...
function render_board_at_help() {
    ...
    document.getElementById('help-choosed-image').classList.remove('d-none');
    document.getElementById('help-choosed-image').src = './img/board_help_section.png';
...
function render_archiv_at_help() {
    ...
    document.getElementById('help-choosed-image').classList.remove('d-none');
    document.getElementById('help-choosed-image').src = './img/archive_help_section.png';
    document.getElementById('help-choosed-text').innerHTML = `The archive section stores all your tasks from the 'done'-section from the board. If you delete your task in the archive it clears out from the backlog and can't be recovered anymore.
    `;
}
